...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "CDoltlite",
            url: "https://github.com/dolthub/doltlite/releases/download/v0.11.42/doltlite-0.11.42.xcframework.zip",
            checksum: "ec82f51ce6b3e38e19a24b3c380afbd22c56b74a46ceb72aa5b09eda4899e36f"
        ),
        .target(
            name: "Doltlite",
