...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "CDoltlite",
            url: "https://github.com/dolthub/doltlite/releases/download/v0.11.27/doltlite-0.11.27.xcframework.zip",
            checksum: "87e09d39454b24f8e9fe5355962804bd3a61010703c85279fe15225fa9533645"
        ),
        .target(
            name: "Doltlite",
