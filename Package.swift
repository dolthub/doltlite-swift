...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "CDoltlite",
            url: "https://github.com/dolthub/doltlite/releases/download/v0.11.56/doltlite-0.11.56.xcframework.zip",
            checksum: "b0e959a0562d42787acbe9304ba4e56567d2c30441e9191d9e17ddf93ac6bb56"
        ),
        .target(
            name: "Doltlite",
