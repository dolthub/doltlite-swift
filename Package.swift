...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "CDoltlite",
            url: "https://github.com/dolthub/doltlite/releases/download/v0.11.29/doltlite-0.11.29.xcframework.zip",
            checksum: "0b823eb1e9612b872af228821b2ffa6ffe44dcce151a26ea0648a5a5dd094d04"
        ),
        .target(
            name: "Doltlite",
