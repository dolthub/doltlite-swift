...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "CDoltlite",
            url: "https://github.com/dolthub/doltlite/releases/download/v0.11.40/doltlite-0.11.40.xcframework.zip",
            checksum: "e6d20fd200b91c34c0c5ff82277ef9c4d573deac312bd44dc3dcd36796dba37a"
        ),
        .target(
            name: "Doltlite",
