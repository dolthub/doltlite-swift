...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "CDoltlite",
            url: "https://github.com/dolthub/doltlite/releases/download/v0.50.1/doltlite-0.50.1.xcframework.zip",
            checksum: "5c86687dafb024bdd06f76f4f2e86c4218f0538bef9acb397ab515fe75442b24"
        ),
        .target(
            name: "Doltlite",
