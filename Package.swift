...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "CDoltlite",
            url: "https://github.com/dolthub/doltlite/releases/download/v0.11.22/doltlite-0.11.22.xcframework.zip",
            checksum: "b7ebb2b8737cd787089481db1df5d43b33c2b5649c010e094901911a437c3e26"
        ),
        .target(
            name: "Doltlite",
