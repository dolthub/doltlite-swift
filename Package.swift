...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "CDoltlite",
            url: "https://github.com/dolthub/doltlite/releases/download/v0.11.57/doltlite-0.11.57.xcframework.zip",
            checksum: "bb7c3fe8e6d03ea5cc9e2984a74f7083339972a72fc1dae150e892e9582ff46d"
        ),
        .target(
            name: "Doltlite",
