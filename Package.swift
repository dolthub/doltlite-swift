...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "CDoltlite",
            url: "https://github.com/dolthub/doltlite/releases/download/v0.11.28/doltlite-0.11.28.xcframework.zip",
            checksum: "e88e7540f1b0b79e20251470ac4cab8a066a7baaf699d52bc36ea57582f8342e"
        ),
        .target(
            name: "Doltlite",
