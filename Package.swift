...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "CDoltlite",
            url: "https://github.com/dolthub/doltlite/releases/download/v0.50.0/doltlite-0.50.0.xcframework.zip",
            checksum: "48fdb251b49585985b93d07435208249a57b6d707e6c9ca7d5c7f0d323c75a9f"
        ),
        .target(
            name: "Doltlite",
