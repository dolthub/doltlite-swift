...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "CDoltlite",
            url: "https://github.com/dolthub/doltlite/releases/download/v0.50.2/doltlite-0.50.2.xcframework.zip",
            checksum: "cfbc1630948bd1fd1cea339198cccf2838c9ddabced4da3d35b8e1883e1238b3"
        ),
        .target(
            name: "Doltlite",
