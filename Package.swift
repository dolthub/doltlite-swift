...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "CDoltlite",
            url: "https://github.com/dolthub/doltlite/releases/download/v0.11.20/doltlite-0.11.20.xcframework.zip",
            checksum: "7718f0a8f8181308f34deedaad12123af9fbbb713292410a0c6eb78d12659b81"
        ),
        .target(
            name: "Doltlite",
