...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "CDoltlite",
            url: "https://github.com/dolthub/doltlite/releases/download/v0.11.50/doltlite-0.11.50.xcframework.zip",
            checksum: "7b9bff6829c20eb18f56744a5453da9b45991cf11fd052bcefb9dfeb11d7d703"
        ),
        .target(
            name: "Doltlite",
