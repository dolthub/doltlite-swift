...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "CDoltlite",
            url: "https://github.com/dolthub/doltlite/releases/download/v0.11.36/doltlite-0.11.36.xcframework.zip",
            checksum: "f4a4ce0cb959d15617ecc5c9d0dee05cf3aae04645debe4322444e4bf36bd6bf"
        ),
        .target(
            name: "Doltlite",
